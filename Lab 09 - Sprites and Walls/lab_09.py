...
class MyGame(arcade.Window):
    ...
    def __init__(self):
        ...
        self.blue_walls_list = None
        self.red_walls_list = None
        self.green_walls_list = None
        self.yellow_walls_list = None
    ...
    def setup(self):
        ...
        self.blue_walls_list = arcade.SpriteList()
        self.red_walls_list = arcade.SpriteList()
        self.green_walls_list = arcade.SpriteList()
        self.yellow_walls_list = arcade.SpriteList()

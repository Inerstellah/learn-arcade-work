...
class MyGame(arcade.Window):
    ...
    def on_draw(self):
        ...
        arcade.draw_text(f"Round: {round_number}", 5, 10, arcade.color.RED, 20)
    ...
    def on_update(self, delta_time):
        ...
        for zombie in self.zombie_list:
            ...
            if arcade.check_for_collision(self.player_sprite.player_sprite, sprite):
                ...
                if self.health_loss_delay >= 0.25:
                    self.player_sprite.health -= 10  # player loses 10 health 4 times per sec when touching zombie
        ...
        if self.has_full_auto:
            ...
            if self.mouse_held and self.fire_rate_delay >= 0.33:
